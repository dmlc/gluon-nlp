...
do
    echo "Running $i"
    python evaluate_pretrained.py --gpu 0  --embedding-name glove --embedding-source $i --logdir results --max-vocab-size 300000
done
...
do
    echo "Running $i"
    python evaluate_pretrained.py --gpu 0  --embedding-name fasttext --embedding-source $i --logdir results --max-vocab-size 300000
done
