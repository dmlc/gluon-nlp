...
Reference: E. Peters, M., et al. "`Deep contextualized word representations <http://aclweb.org/anthology/N18-1202>`_". NAACL 2018
...
.. editting URL for the following table: https://bit.ly/2NBpL72

The dataset used for training the models is wikitext-2.

+---------------+--------------------------------------------+-------------------------------------------+-------------------------------------------+
| Model         | bi_lstm_proj_clip_lm_1500_wikitext-2       | bi_lstm_proj_clip_lm_650_wikitext-2       | bi_lstm_proj_clip_lm_200_wikitext-2       |
+===============+============================================+===========================================+===========================================+
| Mode          | LSTMPC                                     | LSTMPC                                    | LSTMPC                                    |
+---------------+--------------------------------------------+-------------------------------------------+-------------------------------------------+
| Num_layers    | 2                                          | 2                                         | 2                                         |
+---------------+--------------------------------------------+-------------------------------------------+-------------------------------------------+
| Embed size    | 1500                                       | 650                                       | 200                                       |
+---------------+--------------------------------------------+-------------------------------------------+-------------------------------------------+
| Hidden size   | 1500                                       | 650                                       | 200                                       |
+---------------+--------------------------------------------+-------------------------------------------+-------------------------------------------+
| Project size  | 1500                                       | 650                                       | 200                                       |
+---------------+--------------------------------------------+-------------------------------------------+-------------------------------------------+
| Dropout       | 0.65                                       | 0.5                                       | 0.2                                       |
+---------------+--------------------------------------------+-------------------------------------------+-------------------------------------------+
| Dropout_e     | 0                                          | 0                                         | 0                                         |
+---------------+--------------------------------------------+-------------------------------------------+-------------------------------------------+
| Cell clip     | 3                                          | 3                                         | 3                                         |
...
[1] bi_lstm_proj_clip_lm_1500_wikitext-2 (Val PPL  Test PPL )

.. code-block:: console

   $ python -u bi_language_model.py --gpus 0 --model lstmpc --emsize 1500 --nhid 1500 --nlayers 2 --lr 20 --epochs 750 --batch_size 20 --bptt 35 --dropout 0.65 --dropout_e 0 --wd 0 --alpha 0 --beta 0 --projsize 1500 --cellclip 3 --projclip 3 --save bi_lstm_proj_clip_lm_1500_wikitext-2

[2] bi_lstm_proj_clip_lm_650_wikitext-2 (Val PPL  Test PPL )

.. code-block:: console

   $ python -u bi_language_model.py --gpus 0 --model lstmpc --emsize 650 --nhid 650 --nlayers 2 --lr 20 --epochs 750 --batch_size 20 --bptt 35 --dropout 0.5 --dropout_e 0 --wd 0 --alpha 0 --beta 0 --projsize 650 --cellclip 3 --projclip 3 --save bi_lstm_proj_clip_lm_650_wikitext-2

[3] bi_lstm_proj_clip_lm_200_wikitext-2 (Val PPL  Test PPL )

.. code-block:: console

   $ python -u bi_language_model.py --gpus 0 --model lstmpc --emsize 200 --nhid 200 --nlayers 2 --lr 20 --epochs 750 --batch_size 20 --bptt 35 --dropout 0.2 --dropout_e 0 --wd 0 --alpha 0 --beta 0 --projsize 200 --cellclip 3 --projclip 3 --save bi_lstm_proj_clip_lm_200_wikitext-2
