...
parser.add_argument('--dev_dataset_file_squad2', default='./output_dir/out.dev', type=str,
                    help='Path to dev data squad2 features')
parser.add_argument('--dev_dataset_file_squad1', default='./output_dir/out.dev', type=str,
                    help='Path to dev data squad2 features')
...
def evaluate_squad2():
    ...
    dev_data_features = preprocess_dataset(
        ...
        doc_stride=args.doc_stride, num_workers=args.num_workers,
        max_query_length=args.max_query_length, load_from_pickle=args.load_pickle,
        feature_file=args.dev_dataset_file_squad2)
    ...
    output_prediction_file = os.path.join(args.output_dir, 'predictions_squad2.json')
    output_nbest_file = os.path.join(args.output_dir, 'nbest_predictions_squad2.json')
    output_null_log_odds_file = os.path.join(args.output_dir, 'null_odds_squad2.json')
...
def evaluate_squad1():
    ...
    dev_data_features = preprocess_dataset(
        ...
        doc_stride=args.doc_stride, num_workers=args.num_workers,
        max_query_length=args.max_query_length, load_from_pickle=args.load_pickle,
        feature_file=args.dev_dataset_file_squad1)
    ...
    output_prediction_file = os.path.join(args.output_dir, 'predictions_squad1.json')
    output_nbest_file = os.path.join(args.output_dir, 'nbest_predictions_squad1.json')
    output_null_log_odds_file = os.path.join(args.output_dir, 'null_odds_squad1.json')
