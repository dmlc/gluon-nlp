...
horovodrun -np 8 -H localhost:8 python run_pretraining_hvd.py --batch_size 4 --accumulate 8 --max_len 512 --large --lr 1e-4 --data $DATA --warmup_ratio 0.01 --num_steps 1000000 --log_interval=50 --ckpt_dir './ckpt' --ckpt_interval 25000 --num_buckets 10 --dtype float16 #--verbose --profile gpu_0_hvd_large.json
