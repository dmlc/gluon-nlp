...
Inference latency for **bert_12_768_12** in float16 on SQuAD 1.1 on a AWS g4dn.xlarge instance (MXNet 1.6.0).

+--------------+-------------------+--------------+
|  Batch Size  | Sequence Length   | Latency (ms) |
+==============+===================+==============+
| 1            | 80                | 2.34         |
+--------------+-------------------+--------------+
| 1            | 128               | 2.67         |
...
Inference latency for **bert_12_768_12** on Intel CPUs (MXNet 1.7.0 with MKL BLAS and MKLDNN).

+--------------+-------------------+--------------+--------------+--------------+
|  Batch Size  | Sequence Length   | Data Type    | Dataset      | Latency (ms) |
+==============+===================+==============+==============+==============+
| 1            | 128               | float32      | MRPC         | 57.89 *      |
+--------------+-------------------+--------------+--------------+--------------+
| 1            | 128               | int8         | MRPC         | 23.86 **     |
+--------------+-------------------+--------------+--------------+--------------+
| 1            | 384               | float32      | SQuAD 1.1    | 147.49 *     |
+--------------+-------------------+--------------+--------------+--------------+
| 1            | 384               | int8         | SQuAD 1.1    | 79.55 **     |
+--------------+-------------------+--------------+--------------+--------------+

\* AWS EC2 C5.2xlarge instance with 4 physical cores enabled

\** AWS EC2 C5.24xlarge instance with 4 physical cores enabled
