    ...
    for epoch_id in range(args.epochs):
        ...
        for batch_id, example in enumerate(train_data_loader):
            ...
            if (batch_id + 1) % args.print_interval == 0:
                avg_loss /= print_interval
                avg_acc /= print_interval
...
def main(args):
    ...
    dev_dataset = read_dataset(args, 'val_file')
    ...
    if args.mode == 'train':
        train_model(model, train_data_loader, dev_data_loader, vocab.embedding, ctx, args)
