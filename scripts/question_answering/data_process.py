...
Work flow
---
1. Load train/dev.json and glove file, and build the word2idx/char2idx dict and word/char embedding matrix.
2. For each example, encode the word/char represent of context/query, and generate the representation of answer span.
            ...
            for para in article["paragraphs"]:
                ...
                for qa in para["qas"]:
                    ...
                    example = {"context_tokens": context_tokens, "context_chars": context_chars, "ques_tokens": ques_tokens,
                               "ques_chars": ques_chars, "y1s": y1s, "y2s": y2s, "id": qa["id"], "context": context, "spans": spans}
