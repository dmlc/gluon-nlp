...
from gluonnlp.model import DotProductAttentionCell

class MatrixAttention(gluon.Block):
    '''
    ...
    def __init__(self, similarity_function):
        ...
        self._similarity_function = similarity_function or DotProductAttentionCell()
