...
class BERTBasicTokenizer(object):
    ...
    def _is_chinese_char(self, cp):
        """Checks whether CP is the codepoint of a CJK, Katakana and Hiragana character."""
        # This defines a "chinese character" as anything in the CJK, Katakana and Hiragana
        # Unicode block
        # 
        ...
        #
        # Note that the CJK Unicode block is NOT all Korean characters,
        # despite its name. The modern Korean Hangul alphabet is a different block.
        # Those alphabets are used to write space-separated words,
        # so they are not treated specially and handled like the all of the other
        # languages.
