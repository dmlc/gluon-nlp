...
class FixedBucketSampler(Sampler):
    ...
    bucket_scheme : BucketScheme, default ConstWidthBucket
        ...
        LinearWidthBucket: the width of i^{th}  bucket follows :math:`w_i = \alpha * i + 1`
        ExpWidthBucket: the width of i^{th} bucket follows :math:`w_i = \texttt{\detokenize{bucket_len_step}} * w_{i-1}`
    Examples
    --------
