...
__all__ = ['AWDRNN', 'StandardRNN', 'BigRNN', 'MoSRNN']
...
class MoSRNN(Block):
    ...
    num_experts : int
        Number of softmax.
    """
    def __init__(self, mode, vocab_size, embed_size=300, hidden_size=1150, hidden_size_last=650,
                 num_layers=3, tie_weights=True, dropout=0.4, weight_drop=0.5, drop_h=0.2,
                 drop_i=0.55, drop_e=0.1, drop_l=0.29, num_experts=15, **kwargs):
