...
class EmbeddingCenterContextBatchify(object):
    ...
    Returns
    -------
    DataStream over batches. TODO(leezu) elaborate.
    ...
    def __call__(self, corpus):
        ...
        return _EmbeddingCenterContextBatchify(
            corpus, self._batch_size, self._window,
            self._reduce_window_size_randomly, self._shuffle)


class _EmbeddingCenterContextBatchify(object):
    def __init__(self, coded, batch_size, window, reduce_window_size_randomly,
                 shuffle):
        self._coded = coded
        self._batch_size = batch_size
        self._window = window
