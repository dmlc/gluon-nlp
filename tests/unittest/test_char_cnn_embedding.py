...
#     indices_encoded = nd.transpose(nd.one_hot(indices, char_vocab_size), axes=(0, 2, 1))
#     print(indices_encoded)
#     out = net.forward(indices_encoded)
#     print(out)
#
#
...
def test_create_context__embedding_layer():
    input = 'my custom string'
    tokens = nd.array(_simple_tokenize(input))
    print(tokens)
